...
class RAGASEvaluator:
    ...
    def run_evaluation(self, dataset: Dataset) -> pd.DataFrame:
        ...
        """
        logging.info("⏳ Running RAGAS metric evaluation...")
    ...
    def evaluate_from_file(self, result_path: str, output_eval_path: str) -> None:
        ...
        """
        logging.info(f"📥 Loading RAG results from {result_path}...")
        ...
        logging.info(f"✅ Final evaluation saved to: {output_eval_path}")
